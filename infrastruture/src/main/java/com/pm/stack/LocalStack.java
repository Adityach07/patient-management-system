...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("APP_JWT_SECRET", "Y2hhVEc3aHJnb0hYTzMyZ2ZqVkpiZ1RkZG93YWxrUkM="));
        ...
        FargateService patientService = createFargateService("PatientService",
                ...
                patientServiceDb,
                Map.of(
                        "GRPC_CLIENT_BILLING_SERVICE_ADDRESS", "static://billing-service.patient-management.local:9001"
                ));
    ...
    private FargateService createFargateService(String id,
        ...
        if(db != null){
            ...
            ecsSecrets.put("SPRING_DATASOURCE_PASSWORD",
        ...
        containerOptions.secrets(ecsSecrets);
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        ...
                        .environment(Map.of(
                                ...
                                "AUTH_SERVICE_URI", "http://auth-service.patient-management.local:4005",
                                "PATIENT_SERVICE_URI", "http://patient-service.patient-management.local:4000",
                                "BILLING_SERVICE_URI", "http://billing-service.patient-management.local:4001",
                                "ANALYTICS_SERVICE_URI", "http://analytics-service.patient-management.local:5000"
                        ))
